(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_6th_chapter1-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}o=l(i.map(i=>{if(i=t(i,a),i in n)return;n[i]=!0;let o=i.endsWith(`.css`),s=o?`[rel="stylesheet"]`:``,l=!!a;if(l)for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;let u=document.createElement(`link`);if(u.rel=o?`stylesheet`:e,o||(u.as=`script`),u.crossOrigin=``,u.href=i,c&&u.setAttribute(`nonce`,c),document.head.appendChild(u),o)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})};async function i(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function a(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function o(e,t,n=4){let r=new URLSearchParams({category2:e,limit:n.toString(),exclude:t}),i=await fetch(`/api/products?${r}`);return await i.json()}async function s(){let e=await fetch(`/api/categories`);return await e.json()}const c=e=>{let t=[10,20,50,100].map(t=>`<option value="${t}" ${t===e?`selected`:``}>${t}개</option>`);return`
  ...
  `,z=e=>{e.innerHTML=R},B=e=>{e.innerHTML=`
    <div class="min-h-screen bg-gray-50">
      <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
  ...
  `},V=(e,t=null)=>j.subscribe((n,r)=>{if(t){let i=t(n),a=t(r);JSON.stringify(i)!==JSON.stringify(a)&&e(i)}else e(n)}),H=(e,t)=>{let n=[`page`,`limit`,`sort`,`search`,`category1`,`category2`],i=n.filter(n=>t[n]!==e[n]);if(i.length>0){let e={};i.forEach(n=>{t[n]!==void 0&&t[n]!==``&&(e[n]=t[n])}),Object.keys(e).length>0&&r(async()=>{let{updateQueryParams:e}=await import(`./queryStringHandler-u0cS_Sb2.js`);return{updateQueryParams:e}},[]).then(({updateQueryParams:t})=>{t(e)})}};j.store.use(H);const U=document.getElementById(`root`),W=e=>{U.innerHTML=d(e.products,e.limit,e.search,e.categories,e.selectedCategories,e.totalProducts),se(K,ue),b()};V(W);const G=()=>{},le=async()=>{try{let e=await s();j.setCategories(e)}catch(e){console.error(`카테고리 로딩 실패:`,e),j.setCategories({})}},K=async()=>{z(U);try{await le();let e=j.getState(),{products:t,pagination:n}=await i({page:e.page,limit:e.limit,sort:e.sort,search:e.search,category1:e.category1,category2:e.category2});j.setState({products:t,page:1,hasMore:t.length===e.limit,totalProducts:n.total})}catch(e){console.error(`초기 상품 목록 로딩 실패:`,e),U.innerHTML=`<div class="p-4 text-red-600">상품을 불러오지 못했습니다.</div>`}},ue=async()=>{let e=j.getState();if(!(e.isLoading||!e.hasMore)){j.setLoading(!0),j.setPage(e.page+1),z(U);try{let{products:t,pagination:n}=await i({page:e.page+1,limit:e.limit,sort:e.sort,search:e.search,category1:e.category1,category2:e.category2});if(!t||t.length===0){j.setHasMore(!1);return}j.addProducts(t),j.setTotalProducts(n.total)}catch(e){console.error(`다음 상품 로딩 실패:`,e)}finally{j.setLoading(!1)}}},de=async()=>{G(),await K()},q=document.getElementById(`root`),fe=e=>{let t=Math.floor(e),n=e%1!=0,r=5-t-(n?1:0),i=``;for(let e=0;e<t;e++)i+=`
    ...
    `:e.map(e=>`
      ...
      `).join(``),me=(e,t=[])=>{let{productId:n,title:r,image:i,lprice:a,brand:o,category1:s,category2:c,description:l,rating:u,reviewCount:d,stock:f}=e;q.innerHTML=`
    <div class="min-h-screen bg-gray-50">
      <header class="bg-white shadow-sm sticky top-0 z-40">
        <div class="max-w-md mx-auto px-4 py-4">
          <div class="flex items-center justify-between">
  ...
  `,he(e),T(),b()},he=e=>{let t=document.getElementById(`back-button`);t&&t.addEventListener(`click`,async()=>{await $()});let n=document.getElementById(`quantity-increase`),r=document.getElementById(`quantity-decrease`),i=document.getElementById(`quantity-input`);n&&n.addEventListener(`click`,()=>{let e=parseInt(i.value),t=parseInt(i.max);e<t&&(i.value=e+1)}),r&&r.addEventListener(`click`,()=>{let e=parseInt(i.value);e>1&&(i.value=e-1)}),i&&i.addEventListener(`change`,()=>{let e=parseInt(i.value),t=parseInt(i.max);e<1?i.value=1:e>t&&(i.value=t)});let a=document.getElementById(`add-to-cart-btn`);a&&a.addEventListener(`click`,()=>{let t=parseInt(i.value),n={...e,quantity:t};_(n)});let o=document.getElementById(`go-to-product-list`);o&&o.addEventListener(`click`,async()=>{await Q()});let s=document.querySelectorAll(`.breadcrumb-link`);s.forEach(e=>{e.addEventListener(`click`,async t=>{t.preventDefault();let n=e.getAttribute(`data-category1`),r=e.getAttribute(`data-category2`);n?await X(`/?category1=${n}`):r&&await X(`/?category2=${r}`)})});let c=document.querySelectorAll(`.related-product-card`);c.forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.getAttribute(`data-product-id`);t&&await Z(t)})})},ge=async e=>{try{B(q);let t=await a(e);if(!t)throw Error(`상품을 찾을 수 없습니다.`);let n=[];if(t.category2)try{let r=await o(t.category2,e,4);n=r.products||r||[]}catch(e){console.error(`관련 상품 로딩 실패:`,e)}me(t,n)}catch(e){console.error(`상품 상세 로딩 실패:`,e),q.innerHTML=`
    ...
    `;let t=document.getElementById(`error-back-button`);t&&t.addEventListener(`click`,async()=>{await $()})}},_e=()=>`
        <main class="max-w-md mx-auto px-4 py-4">
    ...
    `,J=async e=>{if(e.startsWith(`/product/`)){let t=e.split(`/product/`)[1];if(t){await ge(t);return}}if(e===`/`||e===``){await de();return}document.body.innerHTML=_e()},Y=async()=>{await J(window.location.pathname),window.addEventListener(`popstate`,async()=>{await J(window.location.pathname)}),document.addEventListener(`click`,async e=>{let t=e.target.closest(`a[data-link]`);if(t){e.preventDefault();let n=t.getAttribute(`href`);window.history.pushState({},``,n),await J(n)}})},X=async e=>{window.location.pathname!==e&&(window.history.pushState({},``,e),await J(e))},Z=async e=>{let t=`/product/${e}`;window.location.pathname!==t&&(window.history.pushState({},``,t),await J(t))},Q=async()=>{let e=`/`;window.location.pathname!==e&&(window.history.pushState({},``,e),await J(e))},$=async()=>{window.history.length>1?window.history.back():await Q()},ve=`/front_6th_chapter1-1/`,ye=()=>r(async()=>{let{worker:e}=await import(`./browser-D14UcMCg.js`);return{worker:e}},[]).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`,serviceWorker:{url:`${ve}mockServiceWorker.js`}}));var be=class{constructor(){this.isInitialized=!1}async initialize(){if(!this.isInitialized)try{await Y(),this.isInitialized=!0}catch(e){console.error(`애플리케이션 초기화 실패:`,e)}}async restart(){this.isInitialized=!1,await this.initialize()}};const xe=new be;async function Se(){await xe.initialize()}ye().then(Se);export{E as b,D as c,O as d,T as e,_ as f,C as g,y as h,b as i,g as j,x as k,S as l,v as m};